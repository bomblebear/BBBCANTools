...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plainTextEdit_2.setGeometry(QtCore.QRect(770, 180, 251, 301))
        self.plainTextEdit_2.setObjectName("plainTextEdit_2")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(20, 150, 711, 371))
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.comboBox_ch1_1 = QtWidgets.QComboBox(self.tab)
        self.comboBox_ch1_1.setGeometry(QtCore.QRect(20, 40, 101, 27))
        self.comboBox_ch1_1.setObjectName("comboBox_ch1_1")
        self.comboBox_ch1_2 = QtWidgets.QComboBox(self.tab)
        self.comboBox_ch1_2.setGeometry(QtCore.QRect(20, 90, 101, 27))
        self.comboBox_ch1_2.setObjectName("comboBox_ch1_2")
        self.comboBox_ch1_3 = QtWidgets.QComboBox(self.tab)
        self.comboBox_ch1_3.setGeometry(QtCore.QRect(20, 140, 101, 27))
        self.comboBox_ch1_3.setObjectName("comboBox_ch1_3")
        self.comboBox_ch1_4 = QtWidgets.QComboBox(self.tab)
        self.comboBox_ch1_4.setGeometry(QtCore.QRect(20, 190, 101, 27))
        self.comboBox_ch1_4.setObjectName("comboBox_ch1_4")
        self.button_send_ch1_1 = QtWidgets.QPushButton(self.tab)
        self.button_send_ch1_1.setGeometry(QtCore.QRect(140, 40, 71, 27))
        self.button_send_ch1_1.setObjectName("button_send_ch1_1")
        self.button_send_ch1_2 = QtWidgets.QPushButton(self.tab)
        self.button_send_ch1_2.setGeometry(QtCore.QRect(140, 90, 71, 27))
        self.button_send_ch1_2.setObjectName("button_send_ch1_2")
        self.button_send_ch1_3 = QtWidgets.QPushButton(self.tab)
        self.button_send_ch1_3.setGeometry(QtCore.QRect(140, 140, 71, 27))
        self.button_send_ch1_3.setObjectName("button_send_ch1_3")
        self.button_send_ch1_4 = QtWidgets.QPushButton(self.tab)
        self.button_send_ch1_4.setGeometry(QtCore.QRect(140, 190, 71, 27))
        self.button_send_ch1_4.setObjectName("button_send_ch1_4")
        self.checkbox_ch1_1 = QtWidgets.QCheckBox(self.tab)
        self.checkbox_ch1_1.setGeometry(QtCore.QRect(230, 40, 98, 25))
        self.checkbox_ch1_1.setObjectName("checkbox_ch1_1")
        self.checkbox_ch1_2 = QtWidgets.QCheckBox(self.tab)
        self.checkbox_ch1_2.setGeometry(QtCore.QRect(230, 90, 98, 25))
        self.checkbox_ch1_2.setObjectName("checkbox_ch1_2")
        self.checkbox_ch1_3 = QtWidgets.QCheckBox(self.tab)
        self.checkbox_ch1_3.setGeometry(QtCore.QRect(230, 140, 98, 25))
        self.checkbox_ch1_3.setObjectName("checkbox_ch1_3")
        self.checkbox_ch1_4 = QtWidgets.QCheckBox(self.tab)
        self.checkbox_ch1_4.setGeometry(QtCore.QRect(230, 190, 98, 25))
        self.checkbox_ch1_4.setObjectName("checkbox_ch1_4")
        self.cycletime_ch1_1 = QtWidgets.QLineEdit(self.tab)
        self.cycletime_ch1_1.setGeometry(QtCore.QRect(310, 40, 51, 27))
        self.cycletime_ch1_1.setObjectName("cycletime_ch1_1")
        self.cycletime_ch1_2 = QtWidgets.QLineEdit(self.tab)
        self.cycletime_ch1_2.setGeometry(QtCore.QRect(310, 90, 51, 27))
        self.cycletime_ch1_2.setObjectName("cycletime_ch1_2")
        self.cycletime_ch1_3 = QtWidgets.QLineEdit(self.tab)
        self.cycletime_ch1_3.setGeometry(QtCore.QRect(310, 140, 51, 27))
        self.cycletime_ch1_3.setObjectName("cycletime_ch1_3")
        self.cycletime_ch1_4 = QtWidgets.QLineEdit(self.tab)
        self.cycletime_ch1_4.setGeometry(QtCore.QRect(310, 190, 51, 27))
        self.cycletime_ch1_4.setObjectName("cycletime_ch1_4")
        self.datafield_ch1_1 = QtWidgets.QTextEdit(self.tab)
        self.datafield_ch1_1.setGeometry(QtCore.QRect(420, 40, 261, 31))
        self.datafield_ch1_1.setObjectName("datafield_ch1_1")
        self.datafield_ch1_2 = QtWidgets.QTextEdit(self.tab)
        self.datafield_ch1_2.setGeometry(QtCore.QRect(420, 90, 261, 31))
        self.datafield_ch1_2.setObjectName("datafield_ch1_2")
        self.datafield_ch1_3 = QtWidgets.QTextEdit(self.tab)
        self.datafield_ch1_3.setGeometry(QtCore.QRect(420, 140, 261, 31))
        self.datafield_ch1_3.setObjectName("datafield_ch1_3")
        self.datafield_ch1_4 = QtWidgets.QTextEdit(self.tab)
        self.datafield_ch1_4.setGeometry(QtCore.QRect(420, 190, 261, 31))
        self.datafield_ch1_4.setObjectName("datafield_ch1_4")
        self.label = QtWidgets.QLabel(self.tab)
        self.label.setGeometry(QtCore.QRect(20, 10, 101, 19))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.tab)
        self.label_2.setGeometry(QtCore.QRect(500, 10, 72, 19))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(770, 490, 94, 31))
        self.pushButton_3.setObjectName("pushButton_3")
        self.refreshmsg = QtWidgets.QTextBrowser(self.centralwidget)
        self.refreshmsg.setGeometry(QtCore.QRect(870, 490, 151, 31))
        self.refreshmsg.setObjectName("refreshmsg")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkbox_ch1_1.setText(_translate("MainWindow", "Cyclic"))
        self.checkbox_ch1_2.setText(_translate("MainWindow", "Cyclic"))
        self.checkbox_ch1_3.setText(_translate("MainWindow", "Cyclic"))
        self.checkbox_ch1_4.setText(_translate("MainWindow", "Cyclic"))
        self.label.setText(_translate("MainWindow", "MsgName/ID"))
        self.label_2.setText(_translate("MainWindow", "datafiled"))

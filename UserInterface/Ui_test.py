...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.signal_edit_window.setGeometry(QtCore.QRect(750, 180, 271, 301))
        self.signal_edit_window.setObjectName("signal_edit_window")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(30, 150, 681, 371))
        ...
        self.datafiled_refresh = QtWidgets.QPushButton(self.centralwidget)
        self.datafiled_refresh.setGeometry(QtCore.QRect(750, 490, 94, 31))
        self.datafiled_refresh.setObjectName("datafiled_refresh")
        self.refresh_diag = QtWidgets.QTextBrowser(self.centralwidget)
        self.refresh_diag.setGeometry(QtCore.QRect(860, 490, 161, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.datafiled_refresh.setText(_translate("MainWindow", "save"))
